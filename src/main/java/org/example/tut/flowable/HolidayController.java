...
public class HolidayController {
    ...
    @PostMapping("/claimTask/{taskId}/{userId}")
    public void claimTask(@PathVariable("taskId") String taskId, @PathVariable("userId") String userId){
        holidayService.claimTask(taskId, userId);
    }

    @PostMapping("/unClaimTask/{taskId}/{userId}")
    public void unClaimTask(@PathVariable("taskId") String taskId){
        holidayService.unClaimTask(taskId);
    }
